...
<body style="background-image: url(img3.jpg); overflow-x: hidden;">
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                 ...
                 <div class="row align-items-center">
                    ...
                    <div class="col-lg-8">
                      <h3 style="margin-left:0%; font-weight: bold;">SCHOOL OF ELECTRONICS ENGINEERING</h3>
                       <br>
    <br>
    <br><br>
                    </div>
        ...
        <div class="row" style="margin-left: 2%;">
            <div class="col-sm-3">
                <div class="card" style="width: 18rem;">
                  ...
                  <div class="card-body">
                    <h5 class="card-title" style="color:black;">Innovation Challenge</h5>
                    <div class="card-text" style="color:maroon; height: 8rem;">
                        <b>Venue: </b><br>
                        <b>Schedule: </b><br>
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-body" style="background-color: aqua; "">
                              ...
                              <center ><h5 style="color: black;">School Of Electronics <br>
...
Next generation city 16th-18th Dec.<br>
...
A. Shreya (+91-8839912039) <br>  B. Akshat (+91-897021147)
            ...
            <div class="col-sm-3">
                <div class="card" style="width: 18rem;">
                    <img class="card-img-top" >
                    <div class="card-body">
                        <h5 class="card-title" style="color:black;">Killer Tron</h5>
                        <div class="card-text" style="color:maroon; height: 8rem;">
                        <b>Venue: </b><br>
                        <b>Schedule: </b><br>
                        <b>Participation: </b><br>
                      ...
                      <div class="modal fade" id="myModal2" role="dialog">
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                           ...
                           <i style="font-family: Allura; font-weight: bold;"> Vidnan-Events</i></h5></center>
                                <center>
                                    <h3 style="color:black;">Killertron 3.0</h3>
                                </center>
                                                       <hr style="border-color: black;"> 
                               <p style="color: black;">
...
A. Sandipan (+91-9804113215) <br>  B. Sourav(+91-8348518426)
            ...
            <div class="col-sm-3">
                <div class="card" style="width: 18rem;">
                    <img class="card-img-top" >
                    <div class="card-body">
                        <h5 class="card-title" style="color:black;">Kiwi</h5>
                        <div class="card-text" style="color:maroon; height: 8rem;">
                        <b>Venue: </b><br>
                        <b>Schedule: </b><br>
                        <b>Participation: </b><br>
...
A. Manish (+91-88638480029) <br>  B. Surabhi (+91-9777833256)
            ...
            <div class="col-sm-3">
                <div class="card" style="width: 18rem;">
                    <img class="card-img-top" >
                    <div class="card-body">
                        <h5 class="card-title" style="color:black;">Line Crawler</h5>
                        <div class="card-text" style="color:maroon; height: 8rem;">
                        <b>Venue: </b><br>
                        <b>Schedule: </b><br>
                        <b>Participation: </b><br>
...
At some point in the area, the black line will not be continuous and there will be a gap of not more than 5 centimetres. There will also be a sharp turn after some gaps. So the participants should program their bot in such a way that it does not malfunction at these given points. According to the given figure, the bot should follow the line as the blue line suggest.<br>
...
<p style="color: black;"><b>Contact Details:</b><br>
A. Anirban Nag (+91-9973769996)(anirban161@gmail,com) <br>  B. Shuvam(+91-9938283553)(1604051@kiit.ac.in)
        ...
        <div class="row" style="margin-left: 2%; margin-top: 10%">
        <div class="col-sm-3">
            <div class="card" style="width: 18rem;">
              <img class="card-img-top" >
              <div class="card-body">
                <h5 class="card-title" style="color:black;">Mirror Maze</h5>
                <div class="card-text" style="color:maroon; height: 8rem;">
                        <b>Venue: </b><br>
                        <b>Schedule: </b><br>
                        <b>Participation: </b><br>
...
A. Bishal (+91-9401476420) <br>  B. Saswata(+91-8116340242)
        ...
        <div class="col-sm-3">
            <div class="card" style="width: 18rem;">
                <img class="card-img-top" >
                <div class="card-body">
                    <h5 class="card-title" style="color:black;">Roadrunner</h5>
                    <div class="card-text" style="color:maroon; height: 8rem;">
                        <b>Venue: </b><br>
                        <b>Schedule: </b><br>
                        <b>Participation: </b><br>
...
A. Nomit (+91-8249097249) <br>  B. Vishesh(+91-9711901381)
        ...
        <div class="col-sm-3">
            <div class="card" style="width: 18rem;">
                <img class="card-img-top" >
                <div class="card-body">
                    <h5 class="card-title" style="color:black;">Scavenger's Quest</h5>
                    <div class="card-text" style="color:maroon; height: 8rem;">
                        <b>Venue: </b><br>
                        <b>Schedule: </b><br>
                        <b>Participation: </b><br>
...
A. Samriddhi (+91-7855043720) <br>  B. Shinjini(+91-9938245522)
        ...
        <div class="col-sm-3">
            <div class="card" style="width: 18rem;">
                <img class="card-img-top" >
                <div class="card-body">
                    <h5 class="card-title" style="color:black;">The Salvage Yard</h5>
                    <div class="card-text" style="color:maroon; height: 8rem;">
                        <b>Venue: </b><br>
                        <b>Schedule: </b><br>
                        <b>Participation: </b><br>
...
<p style="color: black;"><b>Contact Details:</b><br>
A. Harshit (+91-7064002267) <br>  B. Krishnesh(+91-7992235489)
