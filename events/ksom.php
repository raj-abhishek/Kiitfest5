        ...
        <div class="row" style="margin-left: 4%;">
            <div class="col-sm-4">
                <div class="card" style="width: 18rem;">
                  ...
                  <div class="card-body">
                    <h5 class="card-title" style="color:black;">Business Simulation</h5>
...
<br>
            ...
            <div class="col-sm-4">
                <div class="card" style="width: 18rem;">
                    <img class="card-img-top" >
                    <div class="card-body">
                        <h5 class="card-title" style="color:black;">Dalal Street</h5>
                        <div class="card-text" style="color:maroon; height: 8rem;">
                        <b>Venue: </b><br>
                        <b>Schedule: </b><br>
                        <b>Participation: </b><br>
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-body" style="background-color: aqua;">
                              ...
                              <center ><h5 style="color: black;">School Of Management <br>
                           <i style="font-family: Allura; font-weight: bold;"> KSOM-Events</i></h5></center>
                               <p style="color: black;"><center ><h3 style="color: black;">Dalal Street</h3></center>
                              <hr style="border-color: black;">
...
<br>
            ...
            <div class="col-sm-4">
                <div class="card" style="width: 18rem;">
                    <img class="card-img-top" >
                    <div class="card-body">
                        <h5 class="card-title" style="color:black;">Dare To Face</h5>
                        <div class="card-text" style="color:maroon; height: 8rem;">
                        <b>Venue: </b><br>
                        <b>Schedule: </b><br>
                        <b>Participation: </b><br>
...
<br>
        ...
        <div class="col-sm-4">
            <div class="card" style="width: 18rem;">
              <img class="card-img-top" >
              <div class="card-body">
                <h5 class="card-title" style="color:black;">Ikadhikaar</h5>
                <div class="card-text" style="color:maroon; height: 8rem;">
                        <b>Venue: </b><br>
                        <b>Schedule: </b><br>
                        <b>Participation: </b><br>
...
<p style="color: black;"><b>Description:</b><br> The strategic business game this will be a monopoly team based game with riddles and puzzles. Judgement will be based on the property valuation at the ends of both the rounds.
...
<br>
        ...
        <div class="col-sm-4">
            <div class="card" style="width: 18rem;">
                <img class="card-img-top" >
                <div class="card-body">
                    <h5 class="card-title" style="color:black;">Milk Run</h5>
                    <div class="card-text" style="color:maroon; height: 8rem;">
                        <b>Venue: </b><br>
                        <b>Schedule: </b><br>
                        <b>Participation: </b><br>
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-body" style="background-color: aqua;">
                              ...
                              <center ><h5 style="color: black;">School Of Management <br>
                           <i style="font-family: Allura; font-weight: bold;"> KSOM-Events</i></h5></center>
                              <p style="color: black;"><center ><h3 style="color: black;">Milk Run</h3></center>
                              <hr style="border-color: black;">
...
<br>
        ...
        <div class="col-sm-4">
            <div class="card" style="width: 18rem;">
                <img class="card-img-top" >
                <div class="card-body">
                    <h5 class="card-title" style="color:black;">Synergy Konflictus 5.0</h5>
                    <div class="card-text" style="color:maroon; height: 8rem;">
                        <b>Venue: </b><br>
                        <b>Schedule: </b><br>
                        <b>Participation: </b><br>
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-body" style="background-color: aqua;">
                              ...
                              <center ><h5 style="color: black;">School Of Management <br>
                           <i style="font-family: Allura; font-weight: bold;"> KSOM-Events</i></h5></center>
                              <p style="color: black;"><center ><h3 style="color: black;">Synergy Konflictus 5.0</h3></center>
                              <hr style="border-color: black;"> 

<p style="color: black;"><b>Description:</b><br> Managing Human Capital is a key business function. Happy employees results in better productivity & greater growth. This game will give participants a firsthand feel of managing employees.
 <br>
<b>Rules and regulations:</b><br>

The Activity will be completed in 3 individual levels divided in level 1,2,3 respectively:
...
<body  style="background-image: url(img.jpg); overflow-x: hidden;">
    <header class="site-header" style="height: 50px;">
        <div class="header-bar">
            <div class="container-fluid">
                <div class="row align-items-center">
                 ...
                 <div class="row align-items-center">
                    ...
                    <div class="col-lg-4">
                      <h4 style="margin-left:0%; font-weight: bold;">SCHOOL OF MANAGEMENT</h4>
                       <br>
    <br>
    <br><br>
                    </div>
