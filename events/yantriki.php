            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                 ...
                 <div class="row align-items-center">
                    ...
                    <div class="col-lg-8">
                      <h3 style="margin-left:0%; font-weight: bold;">SCHOOL OF MECHANICAL ENGINEERING</h3>
                       <br>
    <br>
    <br><br>
                    </div>
        ...
        <div class="row" style="margin-left: 2%;">
            <div class="col-sm-3">
                <div class="card" style="width: 18rem;">
                  ...
                  <div class="card-body">
                    <h5 class="card-title" style="color:black;">AeroRace</h5>
 ...
 <br>  B. Kaustav Ghosh- 7681045132
            ...
            <div class="col-sm-3">
                <div class="card" style="width: 18rem;">
                  <img class="card-img-top" >
                  <div class="card-body">
                    <h5 class="card-title" style="color:black;">Architecture of Destruction</h5>
                    <div class="card-text" style="color:maroon; height: 7rem;">
                        <b>Venue: </b><br>
                        <b>Schedule: </b><br>
                        <b>Participation: </b><br>
                    </div>
...
A. Sarthak Sinha (+91-7684854312)(Roll no:1502057) <br>  B. Aaditya Agrawal (+91-9051469709) (Roll no: 1626013)
            ...
            <div class="col-sm-3">
                <div class="card" style="width: 18rem;">
                  <img class="card-img-top" >
                  <div class="card-body">
                    <h5 class="card-title" style="color:black;">DRONE-ACHARYA</h5>
                    <div class="card-text" style="color:maroon; height: 8rem;">
                        <b>Venue: </b><br>
                        <b>Schedule: </b><br>
                        <b>Participation: </b><br>
...
A. Gourav Dutta (+91-9162867942) <br>  B. Harshit Singh (+91-7978187493) 
            ...
            <div class="col-sm-3">
                <div class="card" style="width: 18rem;">
                  <img class="card-img-top" >
                  <div class="card-body">
                    <h5 class="card-title" style="color:black;">EDCAD</h5>
                    <div class="card-text" style="color:maroon; height: 8rem;">
                        <b>Venue: </b><br>
                        <b>Schedule: </b><br>
                        <b>Participation: </b><br>
...
<ol style="color:black;">
    <li> <b>Stage 1</b>
        <ul style="list-style-type: disc;">
            ...
            <li>Participants have to draw the given views(top, front, side) and have to represent the same in 3D in CAD</li>
        </ul>
    </li>
    <li><b>Stage 2</b>
        <ul style="list-style-type: disc;">
        ...
        <div class="row" style="margin-left: 2%; margin-top: 10%">
            <div class="col-sm-4">
                <div class="card" style="width: 18rem;">
                  <img class="card-img-top">
                  <div class="card-body">
                    <h5 class="card-title" style="color:black;">HydroBooster</h5>
                    <div class="card-text" style="color:maroon; height: 8rem;">
                        <b>Venue: </b><br>
                        <b>Schedule: </b><br>
                        <b>Participation: </b><br>
...
A. Tulika Satpathy (+91-8763185687)(Roll no: 1502317) <br>  B. Prachi Sinha (+91-7504433354) (Roll no: 1502286)
            ...
            <div class="col-sm-4">
                <div class="card" style="width: 18rem;">
                      <img class="card-img-top" >
                      <div class="card-body">
                        <h5 class="card-title" style="color:black;">Mech k Tech Stars</h5>
                        <div class="card-text" style="color:maroon; height: 8rem;">
                            <b>Venue: </b><br>
                            <b>Schedule: </b><br>
                            <b>Participation: </b><br>
...
A. Kaushik Sharma (+91-8723852602)(Roll no:1502113) <br>  B. Obed Min (+91-8457867206) (Roll no: 1502336)
            ...
            <div class="col-sm-4">
                <div class="card" style="width: 18rem;">
                      <img class="card-img-top" >
                      <div class="card-body">
                        <h5 class="card-title" style="color:black;">Sunder Master</h5>
                        <div class="card-text" style="color:maroon; height: 8rem;">
                            <b>Venue: </b><br>
                            <b>Schedule: </b><br>
                            <b>Participation: </b><br>
